...
/*  Исходный файл данных: source.txt в текущей директории относительно исполняемого файла.
 *  Код следующей строки 0x0A0D. Для корректной работы ввода рекомендуется использовать
 * терминал.
