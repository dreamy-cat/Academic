...
// Базовые практические задания. Условные уровни добавить отдельно, здесь полностью задания.

// Все практические главы отдельно, оформленные по файлам. Но исполнять 
