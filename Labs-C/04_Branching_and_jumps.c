...
// Переработать полностью с учетом комменатариев и обновленного плана.
...
void part_4(void)
{
    ...
    d1 = 14.0; d2 = 3.0; d3 = 2.0;
    printf("\n4.36. Float time in minutes after hour(0..59). T = %.2f.\n", d1);
    printf("Traffic light scheme in minutes: green - 3, red - 2.\n");
    d1 = d1 - floor(d1 / (d2 + d3)) * (d2 + d3);
    printf("Remainder of full cycle in minutes is %.2f.\n", d1);
    if (d1 < d2)
