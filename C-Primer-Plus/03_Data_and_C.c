...
// Глава 3. Данне в языке Си.
// Демонстрационная программа с таблицей данных. Также несколько ссылок на Вики. Вспомнить про ввода-вывод.
// Дополнительно можно видео и вставку ассемблерного кода.

// Это версия первая, переработать уже более подробно.
