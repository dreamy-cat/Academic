...
void tasks_chapter_01(void)
{
    printf("Chapter 1, tasks 20 and 21.\n");
    printf("Replace all tabs in stream with spaces.\n");
    printf("Tabs:\t1:\t2:\t3:\t4:\t5:\t6:\t7:\n");
    // Ð’Ð°Ñ€Ð¸Ð°Ð½Ñ‚Ñ‹: Ð¾Ð´Ð½Ð° Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ñ, Ð½ÐµÑÐºÐ¾Ð»ÑŒÐºÐ¾ Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ð¹, Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ð¸ Ð¿Ð¾ ÐºÑ€Ð°Ð¹Ð½Ð¸Ð¼ ÑÐ¸Ð¼Ð²Ð¾Ð»Ð°Ð¼ ÑÐ»ÐµÐ²Ð° Ð¸ ÑÐ¿Ñ€Ð°Ð²Ð°.
#define TAB_SZ 8
    int c, idx = 0;
    while ((c = getchar()) != '\n') {
        if (c == '\t') {
    ...
    // Ð’Ð°Ñ€Ð¸Ð°Ð½Ñ‚Ñ‹: Ð¿ÑƒÑÑ‚Ð°Ñ ÑÑ‚Ñ€Ð¾ÐºÐ° Ð¸Ð· Ð¿Ñ€Ð¾Ð±ÐµÐ»Ð¾Ð², Ð¾Ð´Ð½Ð° Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ñ Ñ Ð½ÑƒÐ»Ñ Ð¸ Ð¿Ñ€Ð¾Ð±ÐµÐ»Ñ‹, Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ñ Ð¼ÐµÐ¶Ð´Ñƒ Ð¿Ð¾Ð»Ð½Ñ‹Ð¼Ð¸ ÑÐ»Ð¾Ð²Ð°Ð¼Ð¸,
    // Ð¿Ñ€Ð¾Ð±ÐµÐ»Ñ‹ Ð¼ÐµÐ¶Ð´Ñƒ Ð¿Ð¾Ð»Ð½Ñ‹Ð¼Ð¸ ÑÐ»Ð¾Ð²Ð°Ð¼Ð¸. ÐŸÑ€Ð¾Ð±ÐµÐ» Ð´Ð¾ Ð¾Ð´Ð½Ð¾Ð¹ Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ð¸, Ð¾Ð´Ð¸Ð½ Ð¿Ñ€Ð¾Ð±ÐµÐ» Ð¿Ð¾ÑÐ»Ðµ Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ð¸.
...
#define MAX_CLM 20
    printf("\nAligment left text with %d width.\n", MAX_CLM);
    // Ð’Ð°Ñ€Ð¸Ð°Ð½Ñ‚Ñ‹ Ð´Ð»Ñ Ñ‚ÐµÑÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ð½Ð¸Ñ: Ð²ÑÑ ÑÑ‚Ñ€Ð¾ÐºÐ° ÑÐ¸Ð¼Ð²Ð¾Ð»Ð¾Ð², Ð²ÑÑ ÑÑ‚Ñ€Ð¾ÐºÐ° Ð¿Ñ€Ð¾Ð±ÐµÐ»Ð¾Ð²/Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ð¹, ÑÑ‚Ñ€Ð¾ÐºÐ° Ð¸Ð· Ð¿Ñ€Ð¾Ð±ÐµÐ»Ð¾Ð² Ð¸ Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ð¹,
    // Ð¾Ð´Ð¸Ð½ ÑÐ¸Ð¼Ð²Ð¾Ð» ÑÐ»ÐµÐ²Ð° Ð¸ Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ñ Ð¸ Ð¿Ñ€Ð¾Ð±ÐµÐ»Ñ‹ Ð¼ÐµÐ¶Ð´Ñƒ Ð¾Ð´Ð½Ð¸Ð¼ ÑÐ¸Ð¼Ð²Ð¾Ð»Ð¾Ð¼, Ð¾Ð´Ð¸Ð½ ÑÐ¸Ð¼Ð²Ð¾Ð» ÑÐ¿Ñ€Ð°Ð²Ð° Ð¸ Ð¿Ñ€Ð¾Ð±ÐµÐ»Ñ‹/Ñ‚Ð°Ð±Ñ‹,
    // Ð¿ÑƒÑÑ‚Ð¾ - ÑÐ¸Ð¼Ð²Ð¾Ð»Ñ‹ Ñ Ð¿ÐµÑ€ÐµÐ½Ð¾ÑÐ¾Ð¼ Ð¸ ÑÐ½Ð¾Ð²Ð° Ð¼Ð½Ð¾Ð³Ð¾ Ð¿Ñ€Ð¾Ð±ÐµÐ»Ð¾Ð² Ð¸ Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸Ð¹ - ÑÐ¸Ð¼Ð²Ð¾Ð»Ñ‹ - Ð¸ Ð¿Ð¾Ñ‚Ð¾Ð¼ Ñ‚Ð°Ð±Ñ‹,
    // Ð¿Ð¾Ð»Ð½Ð°Ñ ÑÑ‚Ñ€Ð¾ÐºÐ° Ð¸ Ð¿Ð¾ÑÐ»ÐµÐ´Ð½ÑÑ Ñ Ð¿Ñ€Ð¾Ð±ÐµÐ»Ð°Ð¼Ð¸ Ð¸ Ñ‚Ð°Ð±ÑƒÐ»ÑÑ†Ð¸ÑÐ¼Ð¸ ÑÐ½Ð¾Ð²Ð° ÑÐ¸Ð¼Ð²Ð¾Ð»Ñ‹.
    char txt[MAXLINE];
    int len, word, column;
    // Testing strings.
    while ((len = getline(txt, MAXLINE)) != 0) {
        column = word = 0;
